...
import 'package:urride_driver/controller/login_conroller.dart';
import 'package:urride_driver/model/user_model.dart';
import 'package:urride_driver/page/auth_screens/forgot_password.dart';
import 'package:urride_driver/page/auth_screens/mobile_number_screen.dart';
import 'package:urride_driver/page/auth_screens/vehicle_info_screen.dart';
                                      ...
                                      if (value != null) {
                                        if (value.success == "success") {
                                          ...
                                          if (userData.statutVehicule !=
                                            ...
                                            Get.to(() => VehicleInfoScreen(phoneNumber: '',),
