...
import 'package:urride_driver/controller/sign_up_controller.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                              ...
                              child: ButtonThem.buildButton(
                                context,
                                title: 'Temporary Driver SignUp '.tr,
                                btnHeight: 45,
                                btnColor: Colors.limeAccent,
                                txtColor: Colors.black,
                                onPress: () async {
                                  ...
                                  if (_formKey.currentState!.validate()) {
                                    Map<String, String> bodyParams1 = {
                                      ...
                                      'login_type': 'phone',
                                      'tonotify': 'yes',
                                      'account_type': 'tempdriver',
                                      'age': "25",
                                    };
                                    await controller.signUp(bodyParams1).then((value) async {
                                      if (value != null) {
                                        if (value.success == "success") {
                                          ...
                                          await Preferences.setUserData(value);
                                          Get.to(AddProfilePhotoScreen(fromOtp: fromOtp));
                                        } else {
