...
import 'package:urride_driver/controller/new_ride_controller.dart';
import 'package:urride_driver/model/ride_model.dart';
import 'package:urride_driver/page/complaint/add_complaint_screen.dart';
import 'package:urride_driver/page/completed/trip_history_screen.dart';
import 'package:urride_driver/page/create_ride/create_ride_screen.dart';
import 'package:urride_driver/page/review_screens/add_review_screen.dart';
import 'package:urride_driver/page/route_view_screen/route_view_screen.dart';
import 'package:urride_driver/themes/button_them.dart';
import 'package:urride_driver/themes/constant_colors.dart';
import 'package:urride_driver/themes/custom_alert_dialog.dart';
import 'package:urride_driver/themes/custom_dialog_box.dart';
import 'package:urride_driver/utils/Preferences.dart';
import 'package:urride_driver/widget/StarRating.dart';
...
class NewRideScreen extends StatelessWidget {
                  ...
                  children: [
                    if (double.parse(controller.totalEarn.value.toString()) < double.parse(Constant.minimumWalletBalance!))
                      Container(
                        ...
                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(10), color: Colors.limeAccent),
                        child: Text(
  ...
  void onBookingConfirmed(BuildContext context) {
    _showNotification('Booking Confirmed', 'You have a new booking!');
    _playNotificationSound();
    _navigateToMainScreen(context);
  }

  void _showNotification(String title, String body) {
    // Implement the notification display logic here
  }
                                                          ...
                                                          Pinput(
                                                            ...
                                                            defaultPinTheme: PinTheme(
                                                              ...
                                                              decoration: BoxDecoration(
                                                                ...
                                                                color: Colors.white,
                                                                border: Border.all(color: Colors.limeAccent, width: 0.7),
                                                              ),
                                                            ),
