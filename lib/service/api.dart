...
class API {
  ...
  static const documentList = "${baseUrl}auto-documents";
  static const getDriverUploadedDocument = "${baseUrl}auto-driver-documents";
  static const driverDocumentAdd = "${baseUrl}auto-driver-documents-add";
  static const driverDocumentUpdate = "${baseUrl}auto-driver-documents-update";


  static const minidocumentList = "${baseUrl}mini-documents";
  static const getminiDriverUploadedDocument = "${baseUrl}mini-driver-documents";
  static const minidriverDocumentAdd = "${baseUrl}mini-driver-documents-add";
  static const minidriverDocumentUpdate = "${baseUrl}mini-driver-documents-update";

  static const sedandocumentList = "${baseUrl}sedan-documents";
  static const getsedanDriverUploadedDocument = "${baseUrl}sedan-driver-documents";
  static const sedandriverDocumentAdd = "${baseUrl}sedan-driver-documents-add";
  static const sedandriverDocumentUpdate = "${baseUrl}sedan-driver-documents-update";


  static const suvdocumentList = "${baseUrl}suv-documents";
  static const getsuvDriverUploadedDocument = "${baseUrl}suv-driver-documents";
  static const suvdriverDocumentAdd = "${baseUrl}suv-driver-documents-add";
  static const suvdriverDocumentUpdate = "${baseUrl}suv-driver-documents-update";

  static const bikedocumentList = "${baseUrl}bike-documents";
  static const getbikeDriverUploadedDocument = "${baseUrl}bike-driver-documents";
  static const bikedriverDocumentAdd = "${baseUrl}bike-driver-documents-add";
  static const bikedriverDocumentUpdate = "${baseUrl}bike-driver-documents-update";
