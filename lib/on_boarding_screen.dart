...
import 'package:urride_driver/controller/on_boarding_controller.dart';
...
class OnBoardingScreen extends StatelessWidget {
  ...
  const OnBoardingScreen({Key? key, required this.intentType}) : super(key: key);
              ...
              children: [
                              ...
                              child: Column(
                                children: [
                                  Text(
                                    ...
                                    style: const TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.w900, letterSpacing: 1.5),
                                  ),
                                  Padding(
                ...
                controller.selectedPageIndex.value == 2
                    ? ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(shape: const StadiumBorder(), primary: Colors.limeAccent, onPrimary: Colors.black),
                        child: const Padding(
                    ...
                    : InkWell(
                        ...
                        child: Text(
                          'skip'.tr,
                          style: const TextStyle(fontSize: 16, letterSpacing: 1.5, color: Colors.white, fontWeight: FontWeight.w500),
                        )),
                    ...
                    children: List.generate(
                      ...
                      (index) => Container(
                          ...
                          decoration: BoxDecoration(
                            color: controller.selectedPageIndex.value == index ? Colors.limeAccent : Colors.limeAccent,
