...
import 'package:urride_driver/model/uploaded_document_model.dart';
...
import '../model/bike_uploaded_document_model.dart';

class BikeDocumentStatusController extends GetxController {
  ...
  var documentList = <BikeUploadedDocumentData>[].obs;
  ...
  Future<dynamic> getCarServiceBooks() async {
    try {
      ...
      if (response.statusCode == 200 && responseBody['success'] == "success") {
        ...
        documentList.value = model.data!.cast<BikeUploadedDocumentData>();
  ...
  Future<dynamic> updateDocument(String driverDocumentId, String path) async {
    try {
      ...
      var request = http.MultipartRequest(
        'POST',
        Uri.parse(API.bikedriverDocumentUpdate),
      );
