...
import 'package:urride_driver/model/brand_model.dart';
import 'package:urride_driver/model/get_vehicle_getegory.dart';
import 'package:urride_driver/model/model.dart';
...
class VehicleInfoController extends GetxController {
  ...
  Future<VehicleData?> getVehicleCategory() async {
    // Remove or comment out the loading indicator lines
// ShowToastDialog.showLoader("Please wait");
    ...
    try {
      ...
      if (response.statusCode == 200) {
        final VehicleCategoryModel getVehicleCategory = VehicleCategoryModel
